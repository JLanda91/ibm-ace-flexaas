...
from pyace import ACERecord, ACEAdminConnection, ACEAdminConnectionError, subdirs_file_content_to_dict, \
    hash_dict_values, create_dir_if_not_exists
...
def query_dict_for_record(record, touched_queries):
    ...
    on the record
    :type touched_queries: dictionary
...
class Exerciser(Resource):
    ...
    def post(self, project_type, project, msgflow, node):
        ...
        :param project_type: choice of either applications/services/rest-apis
        :type project_type: string
        :param project: name of the ACE project
        :type project: string
